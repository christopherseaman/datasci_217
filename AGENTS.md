...
- Major topics should usually include a short conceptual introduction, a relevant visual/table/output, a reference-card table, and a short code snippet. These are guidelines: avoid empty templates, duplicated content, or a table where a sentence suffices.
