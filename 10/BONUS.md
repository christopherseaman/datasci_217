...
_Benchmark them under the same split, measure, and budget. Blue steel, magnum, and le tigre are all amazing, just slightly different, so test them on your data._
