...
- create the ten output artifacts (graders do not rerun or require the notebook);
- run `python check_assignment.py` from the assignment directory;
- confirm the ten required generated files appear in the Git GUI and are not ignored. Extra files do not affect grading.
