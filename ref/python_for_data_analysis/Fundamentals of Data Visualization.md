...
Wilke has written the rare data visualization book that will help you move beyond the
standard line, bar, and pie charts that you know and use. He takes you through the
conceptual underpinnings of what makes an effective visualization and through a library
of different graphs that anyone can utilize. This book will quickly become a go-to
reference for anyone working with and visualizing data.
—Jonathan Schwabish, Senior Fellow, Urban Institute
In this well-illustrated view of what it means to clearly visualize data, Claus Wilke explains
his rationale for why some graphs are effective and others are not. This incredibly useful
guide provides clear examples that beginners can emulate as well as explanations for
stylistic choices so experts can learn what to modify.
—Steve Haroz, Research Scientist, Inria
Wilke’s book is the best practical guide to visualization for anyone with a scientific
disposition. This clear and accessible book is going to live at arm’s reach on
...
The O’Reilly logo is a registered trademark of O’Reilly Media, Inc. Fundamentals of Data Visualization,
...
Bar Plots | 47
Figure 6-3. Highest-grossing movies for the weekend of December 22–24, 2017, displayed
...
indication that all blue bars start at a count of 0. Data source: Encyclopedia Titanica.
...
88 | Chapter 9: Visualizing Many Distributions at Once
Figure 9-9. Temperatures in Lincoln, NE, in 2016, visualized as a ridgeline plot. For each
...
Visualizing Distributions Along the Horizontal Axis | 89
Figure 9-10. Temperatures in Lincoln, NE, in 2016, visualized as a ridgeline plot of his‐
...
90 | Chapter 9: Visualizing Many Distributions at Once
Figure 9-11. Evolution of movie lengths over time. Since the 1960s, the majority of all
...
Visualizing Distributions Along the Horizontal Axis | 91
Figure 9-12. Voting patterns in the US House of Representatives have become increas‐
...
source: Keith Poole.
92 | Chapter 9: Visualizing Many Distributions at Once
CHAPTER 10
...
(Figure 10-1).
93
Figure 10-1. Party composition of the eighth German Bundestag, 1976–1980, visualized
as a pie chart. This visualization highlights that the ruling coalition of SPD and FDP had
...
Figure 10-3. Party composition of the eighth German Bundestag, 1976–1980, visualized
...
Figure 10-5. Market share of five hypothetical companies for the years 2015–2017,
...
98 | Chapter 10: Visualizing Proportions
Figure 10-6. Market share of five hypothetical companies for the years 2015–2017,
...
A Case for Stacked Bars and Stacked Densities | 99
Figure 10-7. Change in the gender composition of the Rwandan parliament over time,
...
age.
100 | Chapter 10: Visualizing Proportions
...
Visualizing Proportions Separately as Parts of the Total | 101
Figure 10-9. Health status by age, shown as proportion of the total number of people in
...
Figure 10-10. Marital status by age. To simplify the figure, I have removed a small num‐
...
102 | Chapter 10: Visualizing Proportions
The same dataset visualized as partial densities is much clearer (Figure 10-11). In par‐
...
Figure 10-11. Marital status by age, shown as proportion of the total number of people
...
Visualizing Proportions Separately as Parts of the Total | 103
Figure 10-12. Marital status by age, shown as proportion of the total number of people
...
105
We reach a total percentage in excess of 100% because we are double-counting
...
Data source: Yoram Reich and Steven J. Fenves, via the UCI Machine Learning Reposi‐
...
106 | Chapter 11: Visualizing Nested Proportions
Figure 11-2. Breakdown of bridges in Pittsburgh by construction material (steel, wood,
iron) and by date of construction (crafts, before 1870, and modern, after 1940), shown
...
Mosaic Plots and Treemaps | 107
Figure 11-3. Breakdown of bridges in Pittsburgh by construction material (steel, wood,
...
108 | Chapter 11: Visualizing Nested Proportions
Figure 11-4. Breakdown of bridges in Pittsburgh by construction material (steel, wood,
...
Mosaic Plots and Treemaps | 109
Figure 11-5. States in the US visualized as a treemap. Each rectangle represents one
...
110 | Chapter 11: Visualizing Nested Proportions
Nested Pies
...
tion era).
Nested Pies | 111
Figure 11-6. Breakdown of bridges in Pittsburgh by construction material (steel, wood,
...
112 | Chapter 11: Visualizing Nested Proportions
Figure 11-7. Breakdown of bridges in Pittsburgh by construction material (steel, wood,
...
Parallel Sets | 113
crafts period, and span the Allegheny and Monongahela rivers in approximately
equal proportions.
Figure 11-8. Breakdown of bridges in Pittsburgh by construction material, length, era of
...
114 | Chapter 11: Visualizing Nested Proportions
Figure 11-9. Breakdown of bridges in Pittsburgh by construction material, length, era of
...
Parallel Sets | 115
Figure 11-10. Breakdown of bridges in Pittsburgh by river, era of construction, length,
...
Data source: Yoram Reich and Steven J. Fenves.
116 | Chapter 11: Visualizing Nested Proportions
CHAPTER 12
...
117
the longest head falls close to the maximum body mass observed, and the bird with
the shortest head falls close to the minimum body mass observed.
Figure 12-1. Head length (measured from the tip of the bill to the back of the head, in
...
(Figure 12-3).
118 | Chapter 12: Visualizing Associations Among Two or More Quantitative Variables
Figure 12-2. Head length versus body mass for 123 blue jays. The birds’ sex is indicated
...
Figure 12-3. Head length versus body mass for 123 blue jays. The birds’ sex is indicated
...
differences that can be virtually impossible to see. In Figure 12-3, I used a size map‐
...
120 | Chapter 12: Visualizing Associations Among Two or More Quantitative Variables
Figure 12-4. All-against-all scatterplot matrix of head length, body mass, and skull size,
...
Correlograms | 121
generated sets of points that differ widely in the degree to which the x and y values
are correlated.
...
panels, the sets of x and y values are identical, but the pairings between individual x and
...
∑i xi− x
2 ∑i yi− y
where xi and yi are two sets of observations and x and y are the corresponding sample
means. We can make a number of observations from this formula. First, the formula
is symmetric in xi and yi, so the correlation of x with y is the same as the correlation
of y with x. Second, the individual values xi and yi only enter the formula in the con‐
text of differences from the respective sample mean, so if we shift an entire dataset by
a constant amount—for example, if we replace xi with xi
′ = xi + C for some constant
122 | Chapter 12: Visualizing Associations Among Two or More Quantitative Variables
C—the correlation coefficient remains unchanged. Third, the correlation coefficient
also remains unchanged if we rescale the data (e.g., xi
′ = Cxi), since the constant C will
...
different oxides for which we have measurements, yielding a total of 6 + 5 + 4 + 3 +
...
Correlograms | 123
display the correlations as colored circles and scale the circle size with the absolute
...
physical traits of people, including quantities such as each person’s height and weight,
...
124 | Chapter 12: Visualizing Associations Among Two or More Quantitative Variables
taller, weigh more, have longer arms and legs, and have larger waist, hip, and chest
...
Figure 12-8. Example principal components analysis in two dimensions. (a) The original
...
Paired Data | 127
from other twins. Therefore, for paired data, we need to choose visualizations that
...
the diagonal. As an example, consider the carbon dioxide (CO2) emissions per per‐
...
close to the diagonal line. Even though CO2 emissions vary over nearly four orders of
...
diagonal line. The majority of countries have seen an increase in CO2 emissions over
the 40 years considered.
Figure 12-11. Carbon dioxide emissions per person in 1970 and 2010, for 166 countries.
Each dot represents one country. The diagonal line represents identical CO2 emissions in
...
128 | Chapter 12: Visualizing Associations Among Two or More Quantitative Variables
Scatterplots such as Figure 12-11 work well when we have a large number of data
...
uses this approach to show the 10 countries with the largest difference in CO2 emis‐
sions per person from 2000 to 2010.
Figure 12-12. Carbon dioxide emissions per person in 2000 and 2010, for the 10 coun‐
...
Figure 12-12 to show CO2 emissions at three time points, here the years 2000, 2005,
...
Paired Data | 129
Figure 12-13. CO2 emissions per person in 2000, 2005, and 2010, for the 10 countries
with the largest difference between the years 2000 and 2010. Data source: Carbon Diox‐
ide Information Analysis Center.
130 | Chapter 12: Visualizing Associations Among Two or More Quantitative Variables
CHAPTER 13
...
(Figure 13-1).
131
Figure 13-1. Monthly submissions to the preprint server bioRxiv, from its inception in
...
132 | Chapter 13: Visualizing Time Series and Other Functions of an Independent Variable
Figure 13-2. Monthly submissions to the preprint server bioRxiv, shown as dots connec‐
...
Figure 13-3. Monthly submissions to the preprint server bioRxiv, shown as a line graph
...
the y axis starts at zero, so that the height of the shaded area at each time point repre‐
sents the data value at that time point.
134 | Chapter 13: Visualizing Time Series and Other Functions of an Independent Variable
Figure 13-4. Monthly submissions to the preprint server bioRxiv, shown as a line graph
...
Multiple Time Series and Dose–Response Curves | 135
Figure 13-5. Monthly submissions to three preprint servers covering biomedical research:
bioRxiv, the q-bio section of arXiv, and PeerJ Preprints. Each dot represents the number
...
Data source: Jordan Anaya, http://www.prepubmed.org.
Figure 13-6. Monthly submissions to three preprint servers covering biomedical research.
...
136 | Chapter 13: Visualizing Time Series and Other Functions of an Independent Variable
Figure 13-6 represents an acceptable visualization of the preprints dataset. However,
...
Multiple Time Series and Dose–Response Curves | 137
Figure 13-8. Dose–response curve showing the mean yield of oat varieties after fertiliza‐
...
138 | Chapter 13: Visualizing Time Series and Other Functions of an Independent Variable
Figure 13-9. Twelve-month change in house prices (a) and unemployment rate (b) over
...
(Figure 3-3).
Time Series of Two or More Response Variables | 139
Figure 13-10. Twelve-month change in house prices versus unemployment rate, from
...
Time Series of Two or More Response Variables | 141
Figure 13-12. Visualizing a high-dimensional time series as a connected scatterplot in
...
142 | Chapter 13: Visualizing Time Series and Other Functions of an Independent Variable
Notably, Figure 13-12a looks almost like a regular line plot, with time running from
...
Time Series of Two or More Response Variables | 143
CHAPTER 14
Visualizing Trends
...
(Figure 14-2b).
146 | Chapter 14: Visualizing Trends
Figure 14-2. Daily closing values of the Dow Jones Industrial Average for the year 2009,
...
Smoothing | 147
8,000 points (Figure 14-2). Similarly, the drop around July 2009 is completely invisi‐
...
148 | Chapter 14: Visualizing Trends
Figure 14-3. Comparison of LOESS fit to 100-day moving average for the Dow Jones
...
Figure 14-4. Fuel-tank capacity versus price of 93 cars released for the 1993 model year.
...
rence University.
Smoothing | 149
LOESS is a very popular smoothing approach because it tends to produce results that
...
150 | Chapter 14: Visualizing Trends
Figure 14-5. Different smoothing models display widely different behaviors, in particular
...
Showing Trends with a Defined Functional Form | 151
equation fits the data at least as well as any of the smoothers we considered previously
(Figure 14-5).
Figure 14-6. Fuel-tank data represented with an explicit analytical model. The solid line
...
prisingly common in real-world datasets. For example, in Chapter 12, I discussed the
...
152 | Chapter 14: Visualizing Trends
Figure 14-7. Head length versus body mass for 123 blue jays. The birds’ sex is indicated
...
www.prepubmed.org/.
Showing Trends with a Defined Functional Form | 153
If the original curve is exponential, y = A exp(mx), then a log-transformation of the y
...
ear fit to log-transformed data, corresponding to y = 43 exp[0.88(x – 2014)]. Data
...
transformed data.
154 | Chapter 14: Visualizing Trends
It is usually better to fit a straight line to transformed data than to
...
is logarithmic. In a log–log plot, power laws of the form y ∼ xα appear as straight lines
...
Detrending and Time-Series Decomposition | 155
Figure 14-10. Freddie Mac House Price Index from 1980 through 2017, for four selected
...
156 | Chapter 14: Visualizing Trends
Figure 14-11. Detrended version of the Freddie Mac House Price Index shown in
...
Detrending and Time-Series Decomposition | 157
To demonstrate the concept of distinct time-series components, I will here decom‐
pose the Keeling curve, which shows changes in CO2 abundance over time
(Figure 14-12). Since 1958, CO2 abundance has been continuously monitored at the
Mauna Loa Observatory in Hawaii, initially under the direction of Charles Keeling.
CO2 is measured in parts per million (ppm). We see a long-term increase in CO2
abundance that is slightly faster than linear, from below 325 ppm in the 1960s to
above 400 in the second decade of the 21st century (Figure 14-12). CO2 abundance
...
northern hemisphere. Plants consume CO2 during photosynthesis. Because most of
the globe’s land masses are located in the northern hemisphere, and plant growth is
most active in the spring and summer, we see an annual global decline in atmospheric
CO2 that coincides with the summer months in the northern hemisphere.
Figure 14-12. The Keeling curve. The Keeling curve shows the change of CO2 abundance
in the atmosphere over time. Shown here are monthly average CO2 readings, expressed
in parts per million (ppm). The CO2 readings fluctuate annually with the seasons but
...
158 | Chapter 14: Visualizing Trends
Figure 14-13. Time-series decomposition of the Keeling curve, showing the monthly aver‐
...
Oceanography.
The decomposition shows that over the last three decades, CO2 abundance has
...
the monthly CO2 readings. More generally, however, the remainder could also
Detrending and Time-Series Decomposition | 159
capture unique external events. For example, if a massive volcano eruption released
substantial amounts of CO2, such an event might be visible as a sudden spike in the
...
160 | Chapter 14: Visualizing Trends
CHAPTER 15
...
161
latitude), and how far we are from the earth’s center (the altitude). Longitude, latitude,
...
162 | Chapter 15: Visualizing Geospatial Data
equivalent to –180° longitude (also referred to as 180°W), near the international date
...
Projections | 163
Figure 15-2. Mercator projection of the world. In this projection, parallels are straight
...
applications.
164 | Chapter 15: Visualizing Geospatial Data
A whole-world projection that is perfectly area-preserving is the Goode homolosine
...
Projections | 165
Shape or area distortions due to map projections are particularly prominent when
...
globe.
166 | Chapter 15: Visualizing Geospatial Data
Figure 15-5 shows a map of all 50 states made using an equal-area Albers projection.
...
Figure 15-5. Map of the United States of America, using an area-preserving Albers pro‐
jection (ESRI:102003, commonly used to project the lower 48 states). Alaska and Hawaii
...
168 | Chapter 15: Visualizing Geospatial Data
Figure 15-7. Visualization of the United States, with the states of Alaska and Hawaii
...
Layers | 169
applications, such as Google Maps. I would like to emphasize that regardless of which
...
Figure 15-8. Wind turbines in the San Francisco Bay Area. Individual wind turbines are
...
Database.
170 | Chapter 15: Visualizing Geospatial Data
Figure 15-9. The individual layers of Figure 15-8. From bottom to top, the figure consists
...
Layers | 171
Figure 15-10. Locations of individual wind turbines in the Shiloh Wind Farm. Each dot
...
172 | Chapter 15: Visualizing Geospatial Data
Figure 15-11. Population density in every US county, shown as a choropleth map. Popu‐
...
as the lighter colors fall into the red-yellow spectrum, so that they appear to be glow‐
...
Choropleth Mapping | 173
Figure 15-12. Population density in every US county, shown as a choropleth map. This
...
174 | Chapter 15: Visualizing Geospatial Data
recognizing a specific color value and matching it against a continuous scale. There‐
...
Choropleth Mapping | 175
Figure 15-14. Median income in every US state, shown as a choropleth map. This map is
...
collapsed.
176 | Chapter 15: Visualizing Geospatial Data
Figure 15-15. Median income in every US state, shown as a cartogram. The shapes of
...
Cartograms | 177
Figure 15-16. Median income in every US state, shown as a cartogram heatmap. Each
...
munity Survey.
178 | Chapter 15: Visualizing Geospatial Data
Figure 15-17. Unemployment rate leading up to and following the 2008 financial crisis,
...
of 2008, 2010, and 2012. States that are geographically close tend to show similar trends
...
181
window, but I don’t know exactly when. It could have been 8:01 a.m., 9:30 a.m., 2
...
182 | Chapter 16: Visualizing Uncertainty
Figure 16-1. Visualizing probability as frequency. There are 100 squares in each grid,
...
your memory.
Framing Probabilities as Frequencies | 183
Figure 16-2. Hypothetical prediction of an election outcome. The blue party is predicted
...
184 | Chapter 16: Visualizing Uncertainty
Figure 16-3. Quantile dot plot representations of the election outcome distribution of
Figure 16-2. (a) The smooth distribution is approximated with 50 dots representing a 2%
chance each. The 6 yellow dots thus correspond to a 12% chance, reasonably close to the
...
Framing Probabilities as Frequencies | 185
Visualizing the Uncertainty of Point Estimates
In Figure 16-2, I showed a “best estimate” and a “margin of error,” but I didn’t explain
...
estimate.
186 | Chapter 16: Visualizing Uncertainty
Figure 16-4. Key concepts of statistical sampling. The variable of interest that we are
...
Visualizing the Uncertainty of Point Estimates | 187
frequentists can generally employ the same types of strategies. Here, I will first discuss
...
99% confidence intervals. All five error bars are derived from the variation in the
...
188 | Chapter 16: Visualizing Uncertainty
Whenever you visualize uncertainty with error bars, you must
...
Figure 16-6. Confidence intervals widen with smaller sample size. Chocolate bars from
...
Visualizing the Uncertainty of Point Estimates | 189
perceive that there is a range of different possibilities. If I showed simple error bars
...
Figure 16-7. Mean chocolate flavor ratings and associated confidence intervals for choc‐
...
190 | Chapter 16: Visualizing Uncertainty
better US bars, and this random chance might look like a systematic rating advantage
...
Figure 16-8. Mean chocolate flavor ratings for manufacturers from five different coun‐
...
Visualizing the Uncertainty of Point Estimates | 191
without a cap at the end (Figure 16-9a,c versus Figure 16-9b,d). There are advantages
...
Figure 16-9. Mean chocolate flavor ratings for manufacturers from four different coun‐
...
192 | Chapter 16: Visualizing Uncertainty
As an alternative to error bars, we could draw confidence strips that gradually fade
...
Figure 16-10. Mean butterfat contents in the milk of four cattle breeds. Error bars indi‐
...
Visualizing the Uncertainty of Point Estimates | 193
Figure 16-11. Median income versus median age for 67 counties in Pennsylvania. Error
...
194 | Chapter 16: Visualizing Uncertainty
of this probability. If a given confidence interval excludes the parameter value under
...
Figure 16-12. Frequency interpretation of a confidence interval. Confidence intervals
(CIs) are best understood in the context of repeated sampling. For each sample, a specific
...
Visualizing the Uncertainty of Point Estimates | 195
emphasizes thinking about the magnitude of an effect, whereas the frequentist think‐
ing emphasizes a binary perspective of an effect either existing or not.
Figure 16-13. Comparison of frequentist confidence intervals and Bayesian credible
...
196 | Chapter 16: Visualizing Uncertainty
discussed at length in their respective chapters, I will here show only one example,
...
page 43).
Figure 16-14. Bayesian posterior distributions of mean chocolate bar ratings, shown as a
...
Visualizing the Uncertainty of Curve Fits | 197
it can rotate (i.e., have different slopes). We can visually show how the confidence
...
198 | Chapter 16: Visualizing Uncertainty
...
Visualizing the Uncertainty of Curve Fits | 199
Figure 16-17. Head length versus body mass for male blue jays. As in the case of error
...
200 | Chapter 16: Visualizing Uncertainty
Figure 16-18. Fuel efficiency versus displacement, for 32 cars (1973–74 models). Each
...
simpler question, such as: if I randomly pick up a Canadian- and a US-manufactured
...
Hypothetical Outcome Plots | 201
Figure 16-19. Schematic of a hypothetical outcome plot for chocolate bar ratings of
...
202 | Chapter 16: Visualizing Uncertainty
Figure 16-20. Schematic of a hypothetical outcome plot for fuel efficiency versus dis‐
...
making Figure 16-19, I verified that the number of times the Canadian bar was shown
winning was close to the true percentage of 53%.
Hypothetical Outcome Plots | 203
PART II
...
Figure 17-1. Median income in the five counties of the state of Hawaii. This figure is mis‐
...
208 | Chapter 17: The Principle of Proportional Ink
Figure 17-2. Median income in the five counties of the state of Hawaii. Here, the y-axis
...
Figure 17-3. Stock price of Facebook (FB) from Oct. 22, 2016 to Jan. 21, 2017. This fig‐
ure seems to imply that the FB stock price collapsed around Nov. 1, 2016. However, this
is misleading, because the y axis starts at $110 instead of $0. Data source: Yahoo!
Finance.
Figure 17-4. Stock price of Facebook (FB) from Oct. 22, 2016 to Jan. 21, 2017. By show‐
ing the stock price on a y scale from $0 to $150, this figure more accurately relays the
magnitude of the FB price drop around Nov. 1, 2016. Data source: Yahoo! Finance.
210 | Chapter 17: The Principle of Proportional Ink
The examples of Figures 17-2 and 17-4 could suggest that bars and shaded areas are
...
Figure 17-5. Change in median income in Hawaiian counties from 2010 to 2015. Data
...
Visualizations Along Linear Axes | 211
Figure 17-6. Decline in Facebook (FB) stock price relative to the price of Oct. 22, 2016.
...
In Chapter 3, I have explained that a log scale is the natural scale to visualize ratios,
...
212 | Chapter 17: The Principle of Proportional Ink
Figure 17-7. GDP in 2007 of countries in Oceania. The lengths of the bars do not accu‐
...
Figure 17-8. GDP in 2007 of countries in Oceania. The lengths of the bars do not accu‐
...
For the data of Figure 17-7, I think bars are inappropriate. Instead, we can simply
...
1/16th the GDP of Papua New Guinea. French Polynesia and New Caledonia are
close but have slightly smaller GDPs than Papua New Guinea.
214 | Chapter 17: The Principle of Proportional Ink
Figure 17-10. GDP in 2007 of countries in Oceania, relative to the GDP of Papua New
...
Direct Area Visualizations | 215
Figure 17-11. Number of inhabitants in Rhode Island counties, shown as a pie chart.
...
216 | Chapter 17: The Principle of Proportional Ink
Figure 17-12. Number of inhabitants in Rhode Island counties, shown as bars. The
...
Direct Area Visualizations | 217
CHAPTER 18
...
engine.
219
Figure 18-1. City fuel economy versus engine displacement, for popular cars released
...
can be seen.
220 | Chapter 18: Handling Overlapping Points
Figure 18-2. City fuel economy versus engine displacement. Because points have been
...
One downside of jittering is that it does change the data and therefore has to be per‐
...
Figure 18-4. City fuel economy versus engine displacement. By adding too much jitter to
...
222 | Chapter 18: Handling Overlapping Points
Figure 18-5. Departure delay in minutes versus flight departure time, for all flights
...
2D histogram is conceptually similar to a 1D histogram, as discussed in Chapter 7,
...
2D Histograms | 223
delay. What it does tell us, though, is that if a plane departs early it either has little
delay or, in very rare cases, a delay of around 900 minutes.
Figure 18-6. Departure delay in minutes versus the flight departure time. Each colored
...
average, closer to the hexagon’s center than the points in an equal-area square are to
...
224 | Chapter 18: Handling Overlapping Points
Figure 18-7. Departure delay in minutes versus the flight departure time. Each colored
...
Contour Lines | 225
Figure 18-8. Head length versus body mass for 123 blue jays, as in Figure 12-1. Each dot
...
226 | Chapter 18: Handling Overlapping Points
Figure 18-9. Head length versus body mass for 123 blue jays. This figure is nearly identi‐
...
Oberlin College.
Contour Lines | 227
In Chapter 12, we also looked at the relationship between head length and body mass
...
228 | Chapter 18: Handling Overlapping Points
Figure 18-11. Price of diamonds versus their carat value, for 53,940 individual dia‐
...
Contour Lines | 229
Figure 18-12. Price of diamonds versus their carat value. As in Figure 18-11, but now
...
230 | Chapter 18: Handling Overlapping Points
Figure 18-13. Price of diamonds versus their carat value. Here, we have taken the den‐
...
233
Figure 19-1. Population growth from 2000 to 2010 versus population size in 2000, for all
...
234 | Chapter 19: Common Pitfalls of Color Use
though we cannot label every individual state without making the figure too crowded,
...
Figure 19-2. Population growth from 2000 to 2010 versus population size in 2000. In
contrast to Figure 19-1, I have now colored states by region and have directly labeled a
subset of states. The majority of states have been left unlabeled to prevent overcrowding
...
This may look like an interesting visual effect, but it is not creating any new insight
into the data or making the figure easier to read.
Figure 19-3. Population growth in the US from 2000 to 2010. The rainbow coloring of
...
236 | Chapter 19: Common Pitfalls of Color Use
Avoid large filled areas of overly saturated colors. They make it dif‐
ficult for your reader to carefully inspect your figure.
Using Nonmonotonic Color Scales to Encode Data Values
In Chapter 4, I listed two critical conditions for designing sequential color scales that
...
Using Nonmonotonic Color Scales to Encode Data Values | 237
the rainbow scale are also overly saturated. Looking at Figure 19-5 for any extended
period of time can be quite uncomfortable.
Figure 19-5. Percentage of people identifying as white in Texas counties. The rainbow
...
238 | Chapter 19: Common Pitfalls of Color Use
of females suffer from some sort of color-vision deficiency (CVD); deuteranomaly is
...
(Figure 19-9).
Not Designing for Color-Vision Deficiency | 239
Figure 19-7. A red–green contrast becomes indistinguishable under red–green CVD
(deuteranomaly or protanomaly).
Figure 19-8. A blue–green contrast becomes indistinguishable under blue–yellow CVD
(tritanomaly).
Figure 19-9. The ColorBrewer PiYG (pink to yellow-green) scale from Figure 4-5 looks
...
240 | Chapter 19: Common Pitfalls of Color Use
of CVD. My preferred qualitative color scale, which I use extensively throughout this
...
Figure 19-10. Qualitative color palette for all color-vision deficiencies [Okabe and Ito
...
Name Hue C, M, Y, K (%) R, G, B (0–255) R, G, B (%)
Hex code Orange #E69F00 41° 0, 50, 100, 0 230, 159, 0 90, 60, 0
...
simulation.
Not Designing for Color-Vision Deficiency | 241
Figure 19-11. Colored elements become difficult to distinguish at small sizes. The top-left
...
simulator.
242 | Chapter 19: Common Pitfalls of Color Use
CHAPTER 20
Redundant Coding
...
other.
243
Figure 20-1. Sepal width versus sepal length for three different Iris species (Iris setosa,
...
tom right).
244 | Chapter 20: Redundant Coding
Figure 20-2. Color-vision deficiency simulation of Figure 20-1. Data source: [Fisher
1936].
...
Designing Legends with Redundant Coding | 245
Figure 20-3. Sepal width versus sepal length for three different Iris species. Compared to
...
246 | Chapter 20: Redundant Coding
Figure 20-4. Color-vision deficiency simulation of Figure 20-3. Because of the use of dif‐
...
Designing Legends with Redundant Coding | 247
Figure 20-5. Stock price over time for four major tech companies. The stock price for
...
248 | Chapter 20: Redundant Coding
Figure 20-6. Stock price over time for four major tech companies. Compared to
...
Designing Legends with Redundant Coding | 249
Figure 20-7. Color-vision deficiency simulation of Figure 20-6. Data source: Yahoo!
Finance.
...
250 | Chapter 20: Redundant Coding
Figure 20-8. Stock price over time for four major tech companies. The stock price for
...
color-coded legend (Figure 20-10). In both Figures 20-9 and 20-10, I have colored the
...
Designing Figures Without Legends | 251
Figure 20-9. Sepal width versus sepal length for three different Iris species. The points
representing different Iris species have been directly labeled with colored ellipses and text
labels. Compared to Figure 20-3, I have removed the background grid here because the
...
252 | Chapter 20: Redundant Coding
allows us to direct-label the marginal density plots rather than the central scatterplot
...
Designing Figures Without Legends | 253
Figure 20-12. Temperatures in Lincoln, NE, in 2016. This figure is a variation of
...
255
As a first example, we will apply this technique to the dataset of Titanic passengers.
...
256 | Chapter 21: Multipanel Figures
Figure 21-2. Average movie rankings versus number of votes, for movies released from
...
For example, consider Figure 21-3, which presents how the proportion of bachelor’s
...
degrees awarded between 1971 and 2015. The y axis of each panel is scaled such that
...
Figure 21-3. Trends in bachelor’s degrees conferred by US institutions of higher learning.
...
cation Statistics.
258 | Chapter 21: Multipanel Figures
Placing all the panels onto the same y axis reveals, however, that this interpretation is
...
Figure 21-4. Trends in bachelor’s degrees conferred by US institutions of higher learning.
...
figure.”
Small Multiples | 259
It is also important to think about the ordering of the individual panels in a small
multiples plot. The plot will be easier to interpret if the ordering follows some logical
principle. In Figure 21-1, I arranged the rows from the highest class (first class) to the
lowest class (third class). In Figure 21-2, I arranged the panels by increasing years
from the top left to the bottom right. In Figure 21-4, I arranged the panels by decreas‐
...
260 | Chapter 21: Multipanel Figures
Figure 21-5. Trends in bachelor’s degrees conferred by US institutions of higher learning.
...
Compound Figures | 261
Figure 21-6. Variation of Figure 21-5 with poor labeling. The panel labels are too large
...
and (b).
262 | Chapter 21: Multipanel Figures
...
have higher red blood cell (RBC, reported in units of 1012 per liter) counts than female
athletes, but there are no such differences for white blood cell counts (WBC, reported in
units of 109 per liter). (c) Male athletes tend to have a lower body fat percentage than
...
Compound Figures | 263
Figure 21-8. Physiology and body composition of male and female athletes. This figure
...
figure.
264 | Chapter 21: Multipanel Figures
Figure 21-9. Variation of Figure 21-8 where all figure panels are slightly misaligned.
Misalignments are ugly and should be avoided. Data source: [Telford and Cunningham
1991].
Compound Figures | 265
CHAPTER 22
...
caption text.
268 | Chapter 22: Titles, Captions, and Tables
...
not require units.
Figure 22-3. Head length versus body mass for 123 blue jays. The birds’ sex is indicated
by color, and the birds’ skull size by symbol size. Head length measurements include the
...
270 | Chapter 22: Titles, Captions, and Tables
colored dots labeled “female” and “male” already indicates that color encodes sex. The
...
5. 6. Columns containing single characters should be centered.
The header fields should be aligned with their data; i.e., the heading for a text col‐
...
274 | Chapter 22: Titles, Captions, and Tables
When authors draw tables with horizontal lines between data rows, the intent is usu‐
...
the “proportion of a graphic’s ink devoted to the non-redundant display of data infor‐
...
277
ink,” then it will result in poor design choices. If we go too far in either direction we
...
figure.
Figure 23-1. Percent body fat versus height in professional male Australian athletes.
...
278 | Chapter 23: Balance the Data and the Context
Figure 23-2. Percent body fat versus height in professional male Australian athletes. This
...
Providing the Appropriate Amount of Context | 279
Figure 23-3. Percent body fat versus height in professional male Australian athletes. In
...
1991].
Figure 23-4. Percent body fat versus height in professional male Australian athletes. This
...
280 | Chapter 23: Balance the Data and the Context
Figures with too little non-data ink commonly suffer from the effect that figure ele‐
...
Titanica.
Providing the Appropriate Amount of Context | 281
Figure 23-6. Survival of passengers on the Titanic, broken down by gender and class.
...
282 | Chapter 23: Balance the Data and the Context
Figure 23-7. Stock price over time for four major tech companies. The stock price for
...
Background Grids | 283
We can go all the way in the opposite direction and remove both the background and
...
Figure 23-8. Indexed stock price over time for four major tech companies. In this variant
...
284 | Chapter 23: Balance the Data and the Context
Figure 23-9. Indexed stock price over time for four major tech companies. Adding a thin
...
Figure 23-10. Indexed stock price over time for four major tech companies. Adding thin
...
Background Grids | 285
For such a minimal grid, we generally draw the lines orthogonally to the direction
...
286 | Chapter 23: Balance the Data and the Context
Figure 23-12. Percent increase in stock price from June 2012 to June 2017, for four major
...
Figure 23-14.
Paired Data | 287
Figure 23-13. Gene expression levels in a mutant bacteriophage T7 relative to wild type.
...
as well as the neighboring genes 8 and 10A (highlighted). Data source: [Paff et al. 2018].
288 | Chapter 23: Balance the Data and the Context
Figure 23-14. Gene expression levels in a mutant bacteriophage T7 relative to wild type.
...
phage. Data source: [Paff et al. 2018].
...
choose Figure 23-13.
Paired Data | 289
Figure 23-15. Gene expression levels in a mutant bacteriophage T7 relative to wild type.
...
and I would prefer Figure 23-13. Data source: [Paff et al. 2018].
Summary
...
visual identity.
290 | Chapter 23: Balance the Data and the Context
CHAPTER 24
...
A somewhat better version of this figure is shown as Figure 24-2. I think the fonts are
...
291
Figure 24-1. Percent body fat versus height in professional male Australian athletes.
...
Cunningham 1991].
Figure 24-2. Percent body fat versus height in male athletes. This figure is an improve‐
...
292 | Chapter 24: Use Larger Axis Labels
Figure 24-3. Percent body fat versus height in male athletes. All figure elements are
...
Use Larger Axis Labels | 293
Figure 24-4. Percent body fat versus height in male athletes. The text elements are fairly
...
Figure 24-5. Percent body fat versus height in male athletes. All figure elements are sized
such that the figure is balanced and can be reproduced at a small scale. Data source:
[Telford and Cunningham 1991].
294 | Chapter 24: Use Larger Axis Labels
You may look at Figure 24-5 and find everything too big. However, keep in mind that
...
297
Figure 25-1. Histogram of the ages of Titanic passengers, drawn with empty bars. The
...
pedia Titanica.
Figure 25-2. Histogram of the ages of Titanic passengers. This is the same histogram as
...
Titanica.
298 | Chapter 25: Avoid Line Drawings
Next, let’s take a look at an old-school density plot. I’m showing density estimates for
...
Avoid Line Drawings | 299
Figure 25-4. Density estimates of the sepal lengths of three different Iris species. By using
...
300 | Chapter 25: Avoid Line Drawings
Line drawings also arise in the context of scatterplots, when different point types are
...
Figure 25-6. City fuel economy versus engine displacement, for cars with front-wheel
...
https://fueleconomy.gov.
Avoid Line Drawings | 301
Figure 25-7. City fuel economy versus engine displacement. By using both different col‐
...
shape, just as we saw in Figure 25-1. This problem is eliminated in Figure 25-9. I have
...
302 | Chapter 25: Avoid Line Drawings
Figure 25-8. Distributions of daily mean temperatures in Lincoln, NE, in 2016. Boxes
are drawn in the traditional way, without shading. Data source: Weather Underground.
Figure 25-9. Distributions of daily mean temperatures in Lincoln, NE, in 2016. By giving
the boxes a light gray shading, we can make them stand out better against the back‐
ground. Data source: Weather Underground.
Avoid Line Drawings | 303
CHAPTER 26
Don’t Go 3D
...
of the area when we look at the pie from a flat angle (Figure 26-1a).
305
Figure 26-1. The same 3D pie chart shown from four different angles. Rotating a pie into
...
306 | Chapter 26: Don’t Go 3D
Figure 26-2. Numbers of female and male passengers on the Titanic traveling in 1st, 2nd,
...
Avoid 3D Position Scales | 307
almost seems to show a different dataset, even though nothing has changed other
than the angle from which we look at the dots.
Figure 26-3. Fuel efficiency versus displacement and power for 32 cars (1973–74 mod‐
...
308 | Chapter 26: Don’t Go 3D
The fundamental problem with such 3D visualizations is that they require two sepa‐
...
scales. For example, in Chapter 2, I plotted five variables of the fuel-efficiency dataset
at once yet used only two position scales (Figure 2-5).
Avoid 3D Position Scales | 309
Figure 26-4. Fuel efficiency versus displacement and power for 32 cars (1973–74 mod‐
...
310 | Chapter 26: Don’t Go 3D
versus displacement and map fuel efficiency onto the size of the dots (Figure 26-6).
Both figures are more useful and less confusing than Figure 26-3.
Figure 26-5. Fuel efficiency versus displacement (a) and power (b) for 32 cars. Data
source: Motor Trend, 1974.
Figure 26-6. Power versus displacement for 32 cars, with fuel efficiency represented by
...
312 | Chapter 26: Don’t Go 3D
Figure 26-8. Mortality rates in Virginia in 1940, visualized as a small multiples plot.
...
Appropriate Use of 3D Visualizations | 313
as rotating animations. While this is not possible in traditional print publications, it
...
314 | Chapter 26: Don’t Go 3D
Figure 26-10. Patterns of evolutionary variation in a protein. The colored tube represents
...
Appropriate Use of 3D Visualizations | 315
PART III
...
JPEG/JPG Joint Photographic Experts Group Bitmap Optimized for photographic images
...
320 | Chapter 27: Understanding the Most Commonly Used Image File Formats
image rarely looks good. There are ways to avoid these problems, such as outlining or
...
Lossless and Lossy Compression of Bitmap Graphics | 321
compression algorithms perform best when images have large areas of uniform color,
...
322 | Chapter 27: Understanding the Most Commonly Used Image File Formats
Figure 27-2. Illustration of JPEG artifacts. (a) The same image is reproduced multiple
...
Lossless and Lossy Compression of Bitmap Graphics | 323
...
when needed.
324 | Chapter 27: Understanding the Most Commonly Used Image File Formats
CHAPTER 28
...
each show the same data but that look somewhat different. Similarly, Figure 28-1a is a
repeat of Figure 9-7, down to the random jitter that was applied to each data point,
whereas Figure 28-1b is only a reproduction of that figure. Figure 28-1b has different
...
326 | Chapter 28: Choosing the Right Visualization Software
Figure 28-1. Repeat and reproduction of a figure. Part (a) is a repeat of Figure 9-7. The
...
Data Exploration Versus Data Presentation | 327
and the higher the likelihood is that you will notice an important feature in the data
...
328 | Chapter 28: Choosing the Right Visualization Software
publication process, when we think everything is done and finalized, we end up
...
Data Exploration Versus Data Presentation | 329
...
330 | Chapter 28: Choosing the Right Visualization Software
of all the data transformations and visual tweaks you have applied, consider taking
...
book; (b) the default theme of ggplot2, the plotting software I have used to make all the
...
there is none. Moreover, any communication creates a story in the audience’s minds.
...
334 | Chapter 29: Telling a Story and Making a Point
once. To tell a complete story, we will usually need multiple visualizations. For exam‐
...
What Is a Story? | 335
Figure 29-1. Growth in monthly submissions to the quantitative biology (q-bio) section
...
instead.
336 | Chapter 29: Telling a Story and Making a Point
Figure 29-2. The leveling off of submission growth to q-bio coincided with the introduc‐
...
Make a Figure for the Generals | 337
rapidly process complex visualizations and understand the key trends and relation‐
...
338 | Chapter 29: Telling a Story and Making a Point
departing out of the New York City area in 2013. I suspect it will take you a while to
process this figure.
Figure 29-3. Mean arrival delay versus distance from New York City. Each point repre‐
...
Make a Figure for the Generals | 339
showed them. Simple and clear is better than complex and confusing. When you’re
trying to show too much data at once, you may end up not showing anything.
Figure 29-4. Mean arrival delay for flights out of the New York City area in 2013, by
...
Figure 29-5. Number of flights out of the New York City area in 2013, by airline. Delta
...
340 | Chapter 29: Telling a Story and Making a Point
...
Build Up Toward Complex Figures | 341
342 | Chapter 29: Telling a Story and Making a Point
Figure 29-7. Departures out of airports in the New York City area in 2013, broken down by airline, airport, and weekday. United
Airlines and ExpressJet make up most of the departures out of Newark Airport (EWR); JetBlue, Delta, American, and Endeavor
make up most of the departures out of JFK; and Delta, American, Envoy, and US Airways make up most of the departures out of
LaGuardia (LGA). Most but not all airlines have fewer departures on weekends than during the workweek. Data source: US Dept. of
Transportation, Bureau of Transportation Statistics.
...
larly memorable.
Figure 29-8. Number of households having one or more of the most popular pets: dogs,
...
Make Your Figures Memorable | 343
for either. In general, we want to strike a balance between the two extremes and make
...
Figure 29-9. Number of households having one or more of the most popular pets, shown
...
can Veterinary Medical Association.
344 | Chapter 29: Telling a Story and Making a Point
Visualizations such as Figure 29-9 are often called isotype plots. The word “isotype”
...
When discussing compound figures in Chapter 21, I mentioned that it is important to
...
analyses will blur together in your audience’s mind, and your audience will have a
...
Be Consistent but Don’t Be Repetitive | 345
Figure 29-10. Physiology and body composition of male and female athletes. Error bars
...
price over time, as demonstrated in Figure 29-11. However, while Figure 29-11a
serves a purpose and should remain as is, Figure 29-11b is at the same time repetitive
...
346 | Chapter 29: Telling a Story and Making a Point
...
Be Consistent but Don’t Be Repetitive | 347
...
Be Consistent but Don’t Be Repetitive | 349
...
are worth a look:
David M. Diez, Christopher D. Barr, Mine Çetinkaya-Rundel. OpenIntro Statistics. 3rd
ed. OpenIntro, Inc., 2015.
...
figures.
352 | Annotated Bibliography
Susan Holmes, Wolfgang Huber. Modern Statistics for Modern Biology. Cambridge
...
354 | Annotated Bibliography
Technical Notes
The entire book was written in R Markdown, using the bookdown, rmarkdown, and
knitr packages. All figures were made with ggplot2, with the help of several add-on
...
356 | Technical Notes
References
Bateman, S., R. Mandryk, C. Gutwin, A. Genest, D. McDine, and C. Brooks. 2010.
“Useful Junk? The Effects of Visual Embellishment on Comprehension and Memora‐
bility of Charts.” ACM Conference on Human Factors in Computing Systems, 2573–82.
doi:10.1145/1753326.1753716.
Becker, R. A., W. S. Cleveland, and M.-J. Shyu. 1996. “The Visual Design and Control
of Trellis Display.” Journal of Computational and Graphical Statistics 5: 123–55.
Bergstrom, C. T., and J. West. 2016. “The Principle of Proportional Ink.” http://calling
bullshit.org/tools/tools_proportional_ink.html.
Borgo, R., A. Abdul-Rahman, F. Mohamed, P. W. Grant, I. Reppa, and L. Floridi.
2012. “An Empirical Study on Using Visual Embellishments in Visualization.” IEEE
Transactions on Visualization and Computer Graphics 18: 2759–68. doi:10.1109/
TVCG.2012.197.
Brewer, Cynthia A. 2017. “ColorBrewer 2.0. Color Advice for Cartography.” http://
www.ColorBrewer.org.
Carr, D. B., R. J. Littlefield, W. L. Nicholson, and J. S. Littlefield. 1987. “Scatterplot
Matrix Techniques for Large N.” Journal of the American Statistical Association 82:
424–36.
Clauset, A., C. R. Shalizi, and M. E. J. Newman. 2009. “Power-Law Distributions in
Empirical Data.” SIAM Review 51: 661–703.
Cleveland, R. B., W. S. Cleveland, J. E. McRae, and I. Terpenning. 1990. “STL: A
Seasonal-Trend Decomposition Procedure Based on Loess.” Journal of Official Statis‐
tics 6: 3–73.
Cleveland, W. S. 1979. “Robust Locally Weighted Regression and Smoothing Scatter‐
plots.” Journal of the American Statistical Association 74: 829–36.
———. 1993. Visualizing Data. Summit, New Jersey: Hobart Press.
357
Dua, D., and E. Karra Taniskidou. 2017. “UCI Machine Learning Repository.” Univer‐
sity of California, Irvine, School of Information; Computer Sciences. https://
archive.ics.uci.edu/ml
Fisher, R. A. 1936. “The Use of Multiple Measurements in Taxonomic Problems.”
Annals of Eugenics 7: 179–188. doi:10.1111/j.1469-1809.1936.tb02137.x.
Haroz, S., R. Kosara, and S. L. Franconeri. 2015. “ISOTYPE Visualization: Working
Memory, Performance, and Engagement with Pictographs.” ACM Conference on
Human Factors in Computing Systems, 1191–1200. doi:10.1145/2702123.2702275.
———. 2016. “The Connected Scatterplot for Presenting Paired Time Series.” IEEE
Transactions on Visualization and Computer Graphics 22: 2174–86. doi:10.1109/
TVCG.2015.2502587.
Hullman, J., P. Resnick, and E. Adar. 2015. “Hypothetical Outcome Plots Outperform
Error Bars and Violin Plots for Inferences About Reliability of Variable Ordering.”
PLOS ONE 10: e0142444. doi:10.1371/journal.pone.0142444.
Kale, A., F. Nguyen, M. Kay, and J. Hullman. 2018. “Hypothetical Outcome Plots Help
Untrained Observers Judge Trends in Ambiguous Data.” IEEE Transactions on Visual‐
ization and Computer Graphics 25: 892–905. doi:10.1109/TVCG.2018.2864909.
Kay, M., T. Kola, J. Hullman, and S. Munson. 2016. “When (Ish) Is My Bus? User-
Centered Visualizations of Uncertainty in Everyday, Mobile Predictive Systems.” CHI
Conference on Human Factors in Computing Systems, 5092–5103. doi:
10.1145/2858036.2858558.
Marcos, M. L., and J. Echave. 2015. “Too Packed to Change: Side-Chain Packing and
Site-Specific Substitution Rates in Protein Evolution.” PeerJ 3: e911.
McDonald, Ian. 2017. “DW-NOMINATE Using ggjoy.” http://rpubs.com/ianrmcdo
nald/293304.
Molyneaux, L., S. K. Gilliam, and L. C. Florant. 1947. “Differences in Virginia Death
Rates by Color, Sex, Age, and Rural or Urban Residence.” American Sociological
Review 12: 525–35.
Okabe, M., and K. Ito. 2008. “Color Universal Design (CUD): How to Make Figures
and Presentations That Are Friendly to Colorblind People.” http://jfly.iam.u-
tokyo.ac.jp/color/.
Paff, M. L., B. R. Jack, B. L. Smith, J. J. Bull, and C. O. Wilke. 2018. “Combinatorial
Approaches to Viral Attenuation.” bioRxiv, 29918. doi:10.1101/299180.
...
358 | References
Sidiropoulos, N., S. H. Sohi, T. L. Pedersen, B. T. Porse, O. Winther, N. Rapin, and F.
O. Bagger. 2018. “SinaPlot: An Enhanced Chart for Simple and Truthful Representa‐
tion of Single Observations over Multiple Classes.” Journal of Computational and
Graphical Statistics 27: 673–76. doi:10.1080/10618600.2017.1366914.
Stone, M., D. Albers Szafir, and V. Setlur. 2014. “An Engineering Model for Color Dif‐
ference as a Function of Size.” 22nd Color and Imaging Conference, 253–258.
Telford, R. D., and R. B. Cunningham. 1991. “Sex, Sport, and Body-Size Dependency
of Hematology in Highly Trained Athletes.” Medicine and Science in Sports and Exer‐
cise 23: 788–94.
The Economist online. 2011. “Corrosive Corruption.” https://www.economist.com/
graphic-detail/2011/12/02/corrosive-corruption.
Tufte, E. R. 1990. Envisioning Information. Cheshire, Connecticut: Graphics Press.
———. 2001. The Visual Display of Quantitative Information. 2nd ed. Cheshire, Con‐
necticut: Graphics Press.
Wehrwein, A. 2017. “It Brings Me ggjoy.” http://austinwehrwein.com/data-
visualization/it-brings-me-ggjoy/.
Wickham, H. 2016. ggplot2: Elegant Graphics for Data Analysis. 2nd ed. New York:
Springer.
Wikipedia, User:Schutz. 2007. “File:Piecharts.svg.” https://en.wikipedia.org/wiki/
File:Piecharts.svg.
Yates, F. 1935. “Complex Experiments.” Supplement to the Journal of the Royal Statisti‐
cal Society 2: 181–247. doi:10.2307/2983638.
References | 359
Symbols
2D bins, 41
2D error bars, 43
...
361
in scatterplots of paired data, using diagonal
line with, 289
...
mation, 233-237
362 | Index
using nonmonotonic color scales to
...
filling, 297
fitted draws, 44
frequencies, framing probabilities as, 181-185
...
Index | 369
trends with a defined functional form,
151-155
tritanomaly/tritanopia, 238, 244
...
370 | Index
About the Author
Claus O. Wilke is a professor of Integrative Biology at The University of Texas at
Austin. He holds a PhD in theoretical physics from the Ruhr-University Bochum,
Germany. Claus is the author or coauthor of over 170 scientific publications, covering
topics in computational biology, mathematical modeling, bioinformatics, evolution‐
ary biology, protein biochemistry, virology, and statistics. He has also authored sev‐
eral popular R packages used for data visualization, such as cowplot and ggridges,
and he is a contributor to the package ggplot2.
Colophon
The animal on the cover of Fundamentals of Data Visualization is a western rosella
parakeet (Platycercus icterotis), a small species of parrot in southwestern Australia.
The name icterotis is derived from ancient Greek for “yellow ear,” referring to the yel‐
low spot on each of the bird’s cheeks. The rosella is very colorful indeed—it has a red
head and neck, a barred green, black, and red back, blue wing feathers, and a blue-
green tail. They average about 10 inches in length.
This parakeet is found in forests, farmland, and parks. It usually has a diet of grass,
seeds, and fruit, but requires more protein in breeding season so it also eats insect
larvae at that time. The birds forage on the ground, gathering in groups of around 20
individuals where food is plentiful. Mating pairs nest in hollows of trees (eucalyptus
trees are often preferred) and lay between 2–7 eggs in each brood.
Western rosella parakeets are popular in aviaries, and they can live 15 years or more.
...
code font is Dalton Maag’s Ubuntu Mono. The figure fonts are Adobe Myriad Pro
and Adobe Myriad Condensed. 