"""Run the Assignment 02 checks against saved artifacts and say what to fix."""
...
def left_to_fix(tests: list[dict]) -> str:
    ...
    A file whose checks all fail reads "output/vitals_report.txt (all 7 checks)"; otherwise its
    failing checks are named, as in "output/vitals_report.txt: mean systolic and lowest systolic".
    """
