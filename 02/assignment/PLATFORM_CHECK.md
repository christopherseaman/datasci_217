...
1. Open the `02/assignment` subtree, or its exported standalone repository, with the supported GUI workflow.
2. Open that repository locally with the supported GUI workflow.
