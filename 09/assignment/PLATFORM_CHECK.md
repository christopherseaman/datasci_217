...
Select that interpreter as the `Python 3` kernel in VS Code/Jupyter. The first notebook code cell verifies Python 3.13, NumPy 2.3.3, and pandas 3.0.5; it does not install packages.
