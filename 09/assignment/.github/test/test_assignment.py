...
class TestQuestion1:
    ...
    def test_q1_datetime_analysis_exists(self):
        ...
        assert filepath.exists(), f"q1_datetime_analysis.csv not found at {filepath}"
    ...
    def test_q1_timezone_report_exists(self):
        ...
        assert filepath.exists(), f"q1_timezone_report.txt not found at {filepath}"
    ...
    def test_q1_timezone_report_has_content(self):
        ...
        assert len(content.strip()) > 50, "q1_timezone_report.txt seems too short"
...
class TestQuestion2:
    ...
    def test_q2_resampling_analysis_exists(self):
        ...
        assert filepath.exists(), f"q2_resampling_analysis.csv not found at {filepath}"
    ...
    def test_q2_missing_data_report_exists(self):
        ...
        assert filepath.exists(), f"q2_missing_data_report.txt not found at {filepath}"
    ...
    def test_q2_missing_data_report_has_content(self):
        ...
        assert len(content.strip()) > 50, "q2_missing_data_report.txt seems too short"
...
class TestQuestion3:
    ...
    def test_q3_rolling_analysis_exists(self):
        ...
        assert filepath.exists(), f"q3_rolling_analysis.csv not found at {filepath}"
    ...
    def test_q3_trend_analysis_exists(self):
        ...
        assert filepath.exists(), f"q3_trend_analysis.png not found at {filepath}"
    ...
    def test_q3_visualization_exists(self):
        ...
        assert filepath.exists(), f"q3_visualization.png not found at {filepath}"
