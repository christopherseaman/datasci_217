...
The assignment requires clean local Jupyter or the VS Code notebook interface. **Assignment Colab is not supported** until the repository-save and Classroom50 pilot passes. Stored notebook output is not execution evidence.
...
6. Submit through the course's Classroom50 route and use its review/feedback link when revising.
