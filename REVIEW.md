...
| 07 | Adds guidance on question, audience, claim, grain, encoding, and accessibility. Adds deterministic assignment fixtures and grading tools. | Assignment instructions and package need reconciliation; generated `07/demo/output/` remains untracked. |
