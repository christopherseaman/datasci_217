...
# STEP 4: Analyzing Student Performance
...
if 'student_stats' in locals() and student_stats:
    ...
    try:
        with open(summary_file, 'w') as f:
            ...
            if 'overall_stats' in locals() and overall_stats:
...
# STEP 6: Final Project Organization
