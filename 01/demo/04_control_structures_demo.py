...
# if user_input > threshold:  # Comparing string to number
...
# This function has incorrect order - broader conditions first
...
# STEP 3: For Loops - Iteration Patterns
...
print("💡 FIX: Use 0-based indexing")
...
# STEP 6: List Comprehensions - Pythonic Style
...
# STEP 8: Practical Example - Grade Analysis System
