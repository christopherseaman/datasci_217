...
print(f"Duplicate records: {sales_df.duplicated().sum()}")
...
def generate_summary_statistics(df):
    ...
    print("\nProduct Performance (ranked by total revenue):")
...
def export_report_assets(fig, df, output_dir='report_outputs'):
    ...
    print(f"Exporting report assets to {output_dir}/")
    ...
    print("✓ Dashboard exported as PNG and PDF")
    ...
    print("✓ Summary statistics exported to Excel")
    ...
    print("✓ Individual plots exported for presentations")
    ...
    print("✓ Report metadata created")
    print(f"\nTotal files exported: {len(metadata['files_created']) + 1}")
...
def export_notebook_programmatically():
    ...
    try:
        ...
        try:
            ...
            print("✓ Notebook exported to PDF")
        except:
            print("⚠ PDF export failed - ensure latex is installed")
